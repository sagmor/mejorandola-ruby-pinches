...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { description: @pin.description, image: @pin.image, link: @pin.link, title: @pin.title }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { description: @pin.description, image: @pin.image, link: @pin.link, title: @pin.title }
    assert_redirected_to pin_path(assigns(:pin))
  end
